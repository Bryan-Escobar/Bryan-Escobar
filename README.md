...
- **Rol actual:** Full Stack Developer Freelancer.
- **Enfoque técnico:** desarrollo de aplicaciones móviles y servicios backend.
- **Experiencia en datos:** diseño e integración de bases de datos **PostgreSQL**.
